...
var BUILDING_DATA = {
    ...
    trap:{
        name:'Trap',
        desc:'Trap can caught the animals',
    ...
    toilet:{
        name:'Restroom',
        desc:'Gain poop, and also take a bathe',
        require:{wood:10,part:5},
        timeNeed:4,
        building:'makeTable',
    },
    sleepPlace:{
        name:'Bed',
        desc:'Gain your health and your vigor',
        require:{bark:2},
        timeNeed:4,
    },
    bigBox:{
        name:'Chest',
        desc:'Store your items!',
        require:{wood:12},
        timeNeed:4,
    },
};
...
var STATE_DATA = {
    ...
    full:{
        name:'Food',
        desc:'You need food to fill this bar',
    },
    moist:{
        name:'Water',
        desc:'You need water to fill this bar',
    },
    hp:{
        name:'Health',
        desc:'You will die if you out of health',
    },
    ps:{
        name:'Power',
        desc:'You need sleep in order to fill this bar',
    },
    san:{
        name:'Vigor',
        desc:'You need Vigor to fight',
    },
}
var COOK_DATA = [
...
var TEMP_DATA = {
        veryHot :{name:'Burn',desc:'Losing water extremely fast'},
        hot     :{name:'Hot',desc:'Eazy to lose water'},
        warm    :{name:'Warm',desc:'Feeling warm'},
        nice    :{name:'Comfortable',desc:'Most comfortable temperature'},
        cool    :{name:'Cool',desc:'Feeling cold'},
        cold    :{name:'Cold',desc:'Start losing power, then effect health'},
        veryCold:{name:'Freeze',desc:'Losing power very fast, then effect health'},
}
var EQUIP_TYPE_DATA = {
    body:'身体',
    hand:'手',
